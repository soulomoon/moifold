...
module CodexWatcher.App.Observe
  ( observeOnce
  , observeOnceExecutor
...
observationSpecs =
  ...
  , issuePureFromCli "implementation-incomplete" \cli ->
      ObservedImplementationIncomplete (maybe "incomplete" id cli.observeCliReason)
  ...
  , prReviewPureFromCli "worker-incomplete" \cli ->
      ObservedWorkerOutcome (WorkerIncomplete (maybe "incomplete" id cli.observeCliReason))
  ...
  , prReviewPureFromCli "reviewer-incomplete" \cli ->
      ObservedReviewerOutcome (ReviewerIncomplete (maybe "incomplete" id cli.observeCliReason))
