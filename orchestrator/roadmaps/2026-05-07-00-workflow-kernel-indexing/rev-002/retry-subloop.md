...
`orchestrator/roadmaps/2026-05-07-00-workflow-kernel-indexing/rev-002/`.
...
- `REJECTED` because an indexed path changes event schema, golden replay, dry-run text, daemon result shape, or action ordering returns the same round to `implement`.
