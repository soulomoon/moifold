...
domainLoopOps =
  DomainLoopOps
    { loopPrestartAndObserve = prestartAndObserve
    , loopObserveWithExecutor = observeWithExecutor
    , loopIdle = idle
    , loopReadActiveTurn = readActiveTurn
    , loopHandleMissingActiveTurn = handleMissingActiveTurn
    , loopClearActiveTurnMarker = clearStaleActiveTurnMarker
    }
